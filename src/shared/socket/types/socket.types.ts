import { ICreateMessage, IMessage, IUnreadSummary, IUnreadCountUpdatePayload } from "@shared/types/message.types";
...
export interface ServerEvents {
    ...
    messagesRead: (data: { chatId: number; readerId: number }) => void;
}
