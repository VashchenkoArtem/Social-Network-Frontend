...
export function PostLikeFilledIcon(props: IIconProps) {
    const { color } = props;
    ...
    return (
        ...
        >
            ...
            />
            <Path
                d="M8.417 12.958l-.084.084-.091-.084C4.283 9.367 1.667 6.992 1.667 4.583c0-1.666 1.25-2.916 2.916-2.916 1.284 0 2.534.833 2.975 1.966h1.55C9.55 2.5 10.8 1.667 12.083 1.667 13.75 1.667 15 2.917 15 4.583c0 2.409-2.617 4.784-6.583 8.375z"
                fill={color}
                fillOpacity={1}
                strokeWidth={0.2}
                stroke={color}
